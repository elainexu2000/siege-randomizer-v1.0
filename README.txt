...
Dependency: see requirements.txt (no dependency requirements as for now)

Installation Instructions:
1. Download project:
	Click on '<>Code' (top right corner) > Download ZIP
2. Extract file (folder: siege-randomizer-vx.x-master)
...
2. Navigate to the directory where SiegeRandomizer.py is located:
	Type "cd" followed by the file path to siege-randomizer-vx.x-master: 'cd C:\Users\...\siege-randomizer-vx.x-master' and press enter.
